...
Page({
  ...
  reportCar: function (e) {
    ...
    //   return false;
    // }
    // console.log(that.data.selectTime.mhour.value);
    // console.log(that.data.selectTime.mmin.value);
    // console.log(that.data.carSeatSelect.value);
            ...
            wx.showToast({
              ...
              success: function (res) {
                ...
                setTimeout(
                  function () {
                    wx.navigateTo({
                      url: 'passenger?id=' + result.data.data,
                      success: function (res) { },
                      fail: function (res) { },
